...
`DOGS_OWNER_TELEGRAM_ID` — numeric chat_id получателя уведомлений о новых заявках. Поддерживает несколько ID через запятую (`111111,222222`) — на новую заявку и на отмену заявки клиентом уведомление уйдёт каждому.
